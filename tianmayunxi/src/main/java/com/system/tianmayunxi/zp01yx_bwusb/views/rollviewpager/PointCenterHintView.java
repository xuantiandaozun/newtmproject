...
public class PointCenterHintView extends LinearLayout implements HintView {
	...
	public PointCenterHintView(Context context){
		super(context);
	}

	public PointCenterHintView(Context context, AttributeSet attrs) {
	...
	/*	switch (gravity) {
		...
		dot_normal.setColor(Color.parseColor("#FF0000"));
