package com.system.tianmayunxi.zp01yx_bwusb.views.titlebar;
...
import com.system.tianmayunxi.zp01yx_bwusb.views.titlebar.utils.KeyboardUtil;
import com.system.tianmayunxi.zp01yx_bwusb.views.titlebar.utils.StatusBarUtil;
...
public class TitleBarView extends ViewGroup {
     ...
     * //默认子View背景色
     */
    private static final int DEFAULT_TEXT_BG_COLOR = Color.TRANSPARENT;
    /**
     *主标题size dp
     */
    ...
    private void initView(Context context) {
        ...
        mLeftLayout.setPadding(10,10,10,10);
    ...
    public TitleBarView setImmersible(Activity activity, boolean immersible, boolean isTransStatusBar, boolean isPlusStatusBar) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            mStatusView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, mStatusBarHeight));
            // 透明状态栏
            window.addFlags(
    ...
    public TitleBarView setTitleMainTextMarquee(boolean enable) {
        ...
        if (enable) {
            ...
            mTitleMain.setOnFocusChangeListener(new OnFocusChangeListener() {
                @Override
    ...
    public TitleBarView setTitleSubTextMarquee(boolean enable) {
        ...
        if (enable) {
            ...
            mTitleSub.setOnFocusChangeListener(new OnFocusChangeListener() {
                @Override
                public void onFocusChange(View v, boolean hasFocus) {
