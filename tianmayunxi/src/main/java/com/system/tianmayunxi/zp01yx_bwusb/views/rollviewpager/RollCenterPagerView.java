package com.system.tianmayunxi.zp01yx_bwusb.views.rollviewpager;
 ...
 * 支持轮播和提示的的viewpager
 */
public class RollCenterPagerView extends RelativeLayout implements OnPageChangeListener {
    ...
    public RollCenterPagerView(Context context) {
        this(context, null);
    }

    public RollCenterPagerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public RollCenterPagerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(AttributeSet attrs) {
        ...
        mode = type.getInteger(R.styleable.RollViewPager_rollviewpager_hint_mode, -1);
    ...
    private void initHint(int mode) {
        switch (mode) {
            ...
            case 0:
                ...
                break;
            case 2:
                initHint(new PointCenterHintView(getContext()));
                break;
            default:
                break;
        }
    ...
    public void  setHintViewMode(int mode){
        this.mode=mode;
        initHint(mode);
    }
