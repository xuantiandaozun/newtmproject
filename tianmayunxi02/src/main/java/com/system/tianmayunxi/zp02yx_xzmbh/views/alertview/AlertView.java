package com.system.tianmayunxi.zp02yx_xzmbh.views.alertview;
...
import com.system.myproject.interfaces.OnDismissListener;
...
public class AlertView {
    ...
    protected void initViews(){
        ...
        switch (style){
            ...
            case ActionSheetImage:
                ...
                contentContainer.setLayoutParams(params);
                gravity = Gravity.BOTTOM;
                initActionSheetViewsImage(layoutInflater);
                break;
            case Alert:
    ...
    public  void initRecycleView(){
        ...
        RecyclerView alertButtonListView = (RecyclerView) contentContainer.findViewById(R.id.alertButtonListView);
        //把cancel作为footerView
        ...
        alertButtonListView.setLayoutManager(layout);
        ImageAdapter adapter = new ImageAdapter(R.layout.image_view_sheet,mDatas);
    ...
    private void initActionSheetViewsImage(LayoutInflater layoutInflater) {
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_image,contentContainer);
